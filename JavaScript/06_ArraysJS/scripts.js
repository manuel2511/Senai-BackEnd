...
// let dimensao = 1
// for (let i = 0; i < 2; i++) {
//  dimensoes.push(prompt.question((`Digite a ${i + 1}° Dimensão: `)));
//  dimensao = dimensao * dimensoes[i] ;
// }
// console.log(`A área do terreno é: ${dimensao}m²`);
/*
...
// function acharMaiorValor(produtos) {
//   let maiorValor = produtos[0].preco;
//   let maiorNome = '';
//   for (let i = 0; i < produtos.length; i++) {
//        if (maiorValor < produtos[i].preco) {
//         maiorValor = produtos[i].preco;
//         maiorNome = produtos[i].nome;
//        }
//   }
//   return {nome: maiorNome, preco: maiorValor};
// }
// function acharMenorValor(produtos) {
//   let menorValor = produtos[0].preco;
//   let menorNome = '';
//   for (let i = 0; i < produtos.length; i++) {
//        if (menorValor > produtos[i].preco) {
//         menorValor = produtos[i].preco;
//         menorNome = produtos[i].nome;
//        }
//   }
//   return {nome: menorNome, preco: menorValor};
// }

// let produtos = [];
// for (let i = 0; i < 3; i++) {
//   let produto ={
//     nome: prompt.question(`Digite o ${i + 1} nome. `),
//     preco: parseFloat(prompt.question(`Digite o preço. `)),
//   };
//   produtos.push(produto);
// }
// let maiorPreco = acharMaiorValor(produtos);
// let menorPreco = acharMenorValor(produtos);
// console.log(`O produto ${maiorPreco.nome} com o seu valor ${maiorPreco.preco} é o maior preço`);
// console.log(`O produto ${menorPreco.nome} com o seu valor ${menorPreco.preco} é o menor preço`);
...
let quantidadeDeMulheresComMaisDeVinteAnos = 0;
let quantidadeDeIndecisos = 0;
for (let i = 0; i < 5; i++) {
  let pessoa = {
    nome: prompt.question(`Digite o ${i + 1} nome. `),
    idade: parseInt(prompt.question(`Digite a idade. `)),
    sexo: parseInt(
      prompt.question(
        `Informe (0)Masculino,(1)Feminino e (2)Não quer declarar. `
      )
    ),
  };
  pessoas.push(pessoa);
  switch (pessoa.sexo) {
    ...
    case 1:
      ...
      if (pessoa.idade > 20) {
        quantidadeDeMulheresComMaisDeVinteAnos++;
      }
      break;
    case 2:
      quantidadeDeIndecisos++;
      break;
...
mediaIdadeHomens = mediaIdadeHomens / pessoas.length;
console.log(`A quantidade de homens do grupo é: ${quantidadeDeHomens}`);
console.log(`A quantidade de mulheres do grupo é: ${quantidadeDeMulheres}`);
console.log(`A quantidade de pessoas que não quiseram responder do grupo é: ${quantidadeDeIndecisos}`);
console.log(`A média das idades do grupo é: ${mediaIdade}`);
console.log(`A média das idades dos homens do grupo é: ${mediaIdadeHomens}`);
console.log(`A média das idades das mulheres acima de 20 anos do grupo é: ${quantidadeDeMulheresComMaisDeVinteAnos}`);
*/
...
function calcular(pessoas) {
  let mediaDasPessoas = 0;
  let maiorPesoPessoa = 0;
  let menorPessoa = 0;
  let maiorPessoa = 0;
  for (let i = 0; i < pessoas.length; i++) {
    mediaDasPessoas += pessoas[i].peso;
    if (pessoas[i].peso > 90) {
      maiorPesoPessoa++;
    }
    if (pessoas[i].peso < 50 && pessoas[i].altura < 1.6) {
      menorPessoa++;
    }
    if (pessoas[i].peso > 100 && pessoas[i].altura > 1.9) {
      maiorPessoa++;
    }
  }
  mediaDasPessoas = mediaDasPessoas / pessoas.length;
  return {
    mediaPessoas: mediaDasPessoas,
    maiorPeso: maiorPesoPessoa,
    menor: menorPessoa,
    maior: maiorPessoa
  };
}
...
pessoas = [];
for (let i = 0; i < 3; i++) {
  let peso = parseFloat(prompt.question(`Digite o peso da ${i + 1}° pessoa. `));
  let altura = parseFloat(prompt.question(`Digite a altura da ${i + 1}° pessoa. `)
  );
  pessoas.push({ peso: peso, altura: altura });
}
let calcularPessoas = calcular(pessoas);
console.log(`A média das alturas do grupo é: ${calcularPessoas.mediaPessoas}`);
console.log(`A quantidade de pessoas do grupo com mais de 90KG é: ${calcularPessoas.maiorPeso}`);
console.log(`A quantidade de pessoas do grupo com menos de 50KG é que tem mais de 1,60m é: ${calcularPessoas.menor}`);
console.log(`A quantidade de pessoas do grupo com mais de 100KG é que tem mais de 1,90m é: ${calcularPessoas.maior}`);
...
function incluirDisciplina() {
  ...
  for (let j = 0; j < 5; j++) {
    let disciplina = {
      disciplina: prompt.question(`Informe a ${j +1 }° disciplina`),
      nota: parseFloat(prompt.question("Informe o número da matricula: ")),
    } 
  }
  return ({disciplina: disciplina.disciplina, nota: disciplina.nota });
}
...
for (let i = 0; i < 3; i++) {
  let aluno = {
    matricula: parseInt(prompt.question("Informe o número da matricula: ")),
    nome: prompt.question("Informe o nome completo: "),
    curso: prompt.question("Informe o nome do curso: "),
    disciplina: incluirDisciplina(),
  }  
  somaNotas += disciplina.nota;
}
somaNotas = somaNotas/disciplina.leaght;
